...
const allParks = [new Park('Green Park', 1997, 0.2, 215), new Park('National Park', 1894, 2.9, 3541), new Park('Oak Park', 1953, 0.4, 949)];

const allStreets = [new Street('Ocean Avenue', 1999, 1.1, 4), new Street('Evergreen Street', 2000, 2.7, 2), new Street('4th Street', 2015, 0.8), new Street('Sunset Boulevard', 1982, 2.5, 5)];
...
const Element = (function() {
    function Element(name, buildYear) {
        this.name = name;
        this.buildYear = buildYear;
    }
...
const Street = (function() {
    function Street(name, buildYear, length, size = 3){
        Element.call(this, name, buildYear);
        this.length = length;
        this.size = size;
    }
